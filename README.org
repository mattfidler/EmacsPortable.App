...
** TODO Add Info from ezwin and gw32 and elsewhere to the infopath
** TODO Add to the manpath
** TODO Compress Info Files
** STARTED Compress Elisp Files
:LOGBOOK:
CLOCK: [2012-01-28 Sat 17:05]--[2012-01-28 Sat 23:56] =>  6:51
:END:
** TODO Upx selected files (not the emacs binary!)
...
** TODO Allow user to select home directory in EmacsOptions.exe
** TODO Remove PuTTY Portable startup screen when launching Pageant Portable.
