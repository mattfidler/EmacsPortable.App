...
- [[http://code.google.com/p/emacs-portable-app/downloads/detail?name=EmacsInstall-24.2-ep0.02.exe][Emacs 24.2]]
** Using Pre-releases
...
The USB directory is determined as follows:
 - /Under Windows/
   ...
   - Checks for =Apps\EmacsPortable.App=,=EmacsPortable.App= or
     =PortableApps\EmacsPortable.App= it assumes this is the USB drive
