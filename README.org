...
*** Handle IE Mailto
In theory this handles Internet explorer mail to, but I believe that
this is broken.
*** Handle IE Viewsource
This handles Internet Explorer View Source. I'm not sure it works.
*** Handle IE News
This handles IE news.  I'm not sure it works.
...
- Modified Debug Icon (original at http://findicons.com/icon/457399/bug?width=512)
