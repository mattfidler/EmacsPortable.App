...
#+BEGIN_SRC nsis
  Function epRegExt
    ...
    done_assoc:
      ...
      ${xml::CreateNode} '<FileType class="org-protocol" urlprotocol="yes"><TypeDescription.en>URL : Org-mode Protocol (org-mode)</TypeDescription.en><Shell><Action name="emacs_portable_app"><Description.en>Open with EmacsPortable.App</Description.en><ExePath>%MYAPPS%\EmacsPortable.App\EmacsPortableApp.exe</ExePath><CmdArgs>&quot;%1&quot;</CmdArgs></Action></Shell></FileType>' $1
...
#+BEGIN_SRC nsis
  Function MissingExt0
    ...
    ${xml::CreateNode} '<Action name="emacs_portable_app"><Description.en>Edit with EmacsPortable.App</Description.en><ExePath>%MYAPPS%\EmacsPortable.App\EmacsPortableApp.exe</ExePath><AppName>%MYAPPS%\EmacsPortable.App\EmacsPortable.App</AppName><CmdArgs>"%1"</CmdArgs></Action>' $1
    ${xml::InsertEndChild} $1 $0
...
Function FoundExt
  ${xml::RootElement} $0 $1
  ${xml::XPathNode} '/KeyFileAssoc/AppsAssoc/FileType[@ext="$7"]/Shell/Action[@name="emacs_portable_app"]' $0
  StrCmp "$0" "-1" notfound
  ${xml::RemoveNode} $0
  notfound:
    Call MissingExt0
...
#+BEGIN_SRC nsis
  Function un.rmExt
    ${xml::RootElement} $0 $1
    ${xml::XPathNode} '/KeyFileAssoc/AppsAssoc/FileType[@ext="$7"]/Shell/Action[@name="emacs_portable_app"]' $0
    DetailPrint '/KeyFileAssoc/AppsAssoc/FileType[@ext="$7"]/Shell/Action[@name="emacs_portable_app"] $0'
    StrCmp "$0" "-1" notfound
    ${xml::RemoveNode} $0
    ${xml::RootElement} $0 $1
...
#+BEGIN_SRC nsis
  Function GetDriveVars
    ...
    gpa:
      ...
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyDB/Apps/Software[@id="emacs_portable_app"]' $0
      StrCmp "$0" "-1" +2
      ${xml::RemoveNode} $0
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} "/LiberKeyDB/Apps" $0
      ${xml::CreateNode} '<Software id="emacs_portable_app"><Name>EmacsPortable.App</Name><ExePath>%MyApps%\EmacsPortable.App\EmacsPortableApp.exe</ExePath><Platform>2000/XP/Vista/7</Platform><License>GPL 3</License><Developer>Matthew L. Fidler (Portable Launcher) and Emacs Team</Developer><WebSite>https://github.com/mlf176f2/EmacsPortable.App</WebSite></Software>' $1
      ${xml::InsertEndChild} $1 $0
      
      ${xml::XPathNode} '/LiberKeyDB/Apps/Software[@id="emacs_portable_app_debug"]' $0
      StrCmp "$0" "-1" +2
      ${xml::RemoveNode} $0
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} "/LiberKeyDB/Apps" $0
      ${xml::CreateNode} '<Software id="user_emacs_portable_app_debug"><Name>EmacsPortable.App Debug</Name><ExePath>%MyApps%\EmacsPortable.App\EmacsDebug.exe</ExePath><Platform>2000/XP/Vista/7</Platform><License>GPL 3</License><Developer>Matthew L. Fidler (Portable Launcher) and Emacs Team</Developer><WebSite>https://github.com/mlf176f2/EmacsPortable.App</WebSite></Software>' $1
      ${xml::InsertEndChild} $1 $0
      
      ${xml::XPathNode} '/LiberKeyDB/Apps/Software[@id="emacs_portable_app_q"]' $0
      StrCmp "$0" "-1" +2
      ${xml::RemoveNode} $0
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} "/LiberKeyDB/Apps" $0
      ${xml::CreateNode} '<Software id="user_emacs_portable_app_q"><Name>EmacsPortable.App -Q</Name><ExePath>%MyApps%\EmacsPortable.App\Emacs-Q.exe</ExePath><Platform>2000/XP/Vista/7</Platform><License>GPL 3</License><Developer>Matthew L. Fidler (Portable Launcher) and Emacs Team</Developer><WebSite>https://github.com/mlf176f2/EmacsPortable.App</WebSite></Software>' $1
      ${xml::InsertEndChild} $1 $0
      
      ${xml::XPathNode} '/LiberKeyDB/Apps/Software[@id="emacs_portable_app_dos"]' $0
      StrCmp "$0" "-1" +2
      ${xml::RemoveNode} $0
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} "/LiberKeyDB/Apps" $0
      ${xml::CreateNode} '<Software id="user_emacs_portable_app_Dos"><Name>EmacsPortable.App (Dos Mode)</Name><ExePath>%MyApps%\EmacsPortable.App\EmacsDos.exe</ExePath><Platform>2000/XP/Vista/7</Platform><License>GPL 3</License><Developer>Matthew L. Fidler (Portable Launcher) and Emacs Team</Developer><WebSite>https://github.com/mlf176f2/EmacsPortable.App</WebSite></Software>' $1
      ${xml::InsertEndChild} $1 $0
      ...
      ${xml::InsertEndChild} $1 $0
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]/Software[@id="user_emacs_portable_app"]' $0
      StrCmp "$0" "-1" 0 +5
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]' $0
      ${xml::CreateNode} '<Software id="user_emacs_portable_app"></Software>' $1
      ${xml::InsertEndChild} $1 $0
      
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]/Software[@id="user_emacs_portable_app_debug"]' $0
      StrCmp "$0" "-1" 0 +5
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]' $0    
      ${xml::CreateNode} '<Software id="user_emacs_portable_app_debug"></Software>' $1
      ${xml::InsertEndChild} $1 $0
  
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]/Software[@id="user_emacs_portable_app_q"]' $0
      StrCmp "$0" "-1" 0 +5
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]' $0 
      ${xml::CreateNode} '<Software id="user_emacs_portable_app_q"></Software>' $1
      ${xml::InsertEndChild} $1 $0
  
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]/Software[@id="user_emacs_portable_app_dos"]' $0
      StrCmp "$0" "-1" 0 +5
      ${xml::RootElement} $0 $1
      ${xml::XPathNode} '/LiberKeyMenu/Category[@name="Text editor"]' $0 
      ${xml::CreateNode} '<Software id="user_emacs_portable_app_dos"></Software>' $1
      ${xml::InsertEndChild} $1 $0
...
#+BEGIN_SRC nsis
  Section "Main" sec_main
    ...
    MessageBox MB_OK "Associations and Programs have been integrated into LiberKey.  You may need to restart to see them."
    end:
      ClearErrors
  SectionEnd
