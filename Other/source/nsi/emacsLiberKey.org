...
#+BEGIN_SRC nsis
  Function MissingExt0
    ...
    ${xml::CreateNode} '<Action name="edit_with_emacsportableapp__liberkey"><Description.en>Edit with EmacsPortable.App (LiberKey)</Description.en><ExePath>%MYAPPS%\EmacsPortable.App\EmacsPortableApp.exe</ExePath><CmdArgs>"%1"</CmdArgs></Action>' $1
    ${xml::InsertEndChild} $1 $0
...
#+BEGIN_SRC nsis
  Section "Main" sec_main
    ...
    MessageBox MB_OK "Associations and Programs have been integrated into LiberKey.  You will need to restart to see them.  If you update your LiberKey, these settings may be overwritten."
    end:
      ClearErrors
  SectionEnd
