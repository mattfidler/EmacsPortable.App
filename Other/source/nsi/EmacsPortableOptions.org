...
#+BEGIN_SRC nsis
  ...
  Var hCtl_assocs_CheckBox1
  Var hCtl_assocs_AssocList
  Var hCtl_assocs_Button1
  Var hCtl_assocs_Button2
  Var hCtl_assocs_Button3
  ...
  Function fnc_assocs_Create
    ...
    Pop $hCtl_assocs_Button1
    
    ; === Button2 (type: Button) ===
    ${NSD_CreateButton} 64u 74u 49u 13u "Save"
    Pop $hCtl_assocs_Button2
    
    ; === Button3 (type: Button) ===
    ${NSD_CreateButton} 118u 74u 49u 13u "Delete"
    Pop $hCtl_assocs_Button3
  ...
  Function fnc_assocs_Show
    ...
    ${NSD_CreateTimer} PopulateSteal 500
...
#+BEGIN_SRC nsis
  var hCtl_assocs_AssocList_Notify_Click
  Function hCtl_assocs_AssocList_Notify
    System::Store SR1R1R0
    StrCpy $hCtl_assocs_AssocList_Notify_Click ""
    ${Switch} $R1
      ${Case} ${LVN_ITEMCHANGED}
        ...
        StrCpy $hCtl_assocs_AssocList_Notify_Click "1"
        ${Break}
    ${EndSwitch}
    System::Store L
    ${If} $hCtl_assocs_AssocList_Notify_Click != ""
      Call PopulateSteal        
      StrCpy $hCtl_assocs_AssocList_Notify_Click ""
    ${EndIf}
    end:
