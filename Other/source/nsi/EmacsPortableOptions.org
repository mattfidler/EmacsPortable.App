...
#+BEGIN_SRC nsis
  ...
  Function fnc_proxy_Create
    ...
    ${If} $hCtl_proxy == error
      Abort
    ${EndIf}
    !insertmacro MUI_HEADER_TEXT "Proxy Settings" "Sets EmacsPortable.App Proxy Settings. These settings should be different for different networks. "
    ...
    ; === Label5 (type: Label) ===
    ${NSD_CreateLabel} 79u 60u 205u 12u "Note: Proxy settings are different"
