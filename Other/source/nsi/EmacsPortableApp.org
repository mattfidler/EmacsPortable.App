...
#+PROPERTY: header-args :tangle EmacsPortableApp.nsi
* Launcher Properties
** Setup Options
I want:
...
#+BEGIN_SRC nsis
  Function SetupDirs
    ${If} ${FileExists} "$EXEDIR\..\emacs-$option_version\share\emacs\$option_version\etc"
    ...
    ${ElseIf} ${FileExists} "$EXEDIR\..\emacs-$option_version\etc"
