  ...
  Function CreateZip
    ...
    found_7z:
      ...
      ${Else} 
        ...
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\emacs-$option_version.exe $TEMP\epz\emacs-$option_version\emacs.exe
        ...
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\emacsclient.exe $TEMP\epz\emacs-$option_version\emacsclient.exe
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\runemacs.exe $TEMP\epz\emacs-$option_version\runemacs.exe
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\runemacs.exe $TEMP\epz\emacs-$option_version\runemacs.exe
