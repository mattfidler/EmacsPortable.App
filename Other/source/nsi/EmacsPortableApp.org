...
#+BEGIN_SRC nsis
  Function RemRegSetup
    IfFileExists '$TEMP\ep\EP-RemoveReg.exe' +2
    CopyFiles /SILENT /FILESONLY '$EXEDIR\App\eps\RemoveReg.exe' '$TEMP\ep\EP-RemoveReg.exe'
...
#+BEGIN_SRC nsis
  Function InstallFonts
    ...
    no_fonts:
      ...
      IfFileExists "$TEMP\ep\ep-rmfont.exe" +2 0
      CopyFiles /SILENT "$EXEDIR\App\eps\rmfont.exe" "$TEMP\ep\ep-rmfont.exe"
 ...
 #+BEGIN_SRC nsis
   Section "Main" sec_main
     ...
     start_emacs_gdb:
       ...
       Exec "$EXEDIR\App\eps\run.exe $TEMP\ep\EP-RemoveReg.exe"
