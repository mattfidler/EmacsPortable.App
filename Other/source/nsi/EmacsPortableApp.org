...
#+BEGIN_SRC nsis  
  Function parseParameters
    ...
    read_cmd_line_ver:
      ...
      IfFileExists "$EXEDIR\..\emacs\bin\emacs-$option_version.exe" emacs_ver_done
      IfFileExists "$EXEDIR\..\emacs\bare-bin-$option_version.7z" emacs_ver_done
    ...
    loop_ver:
      StrCmp $1 "" ver2
      DetailPrint "Looking for emacs version in emacs- ($1)"
      ${If} ${FileExists} $EXEDIR\..\$1\etc
        StrCpy $1 $1 "" 6
        StrCpy $2 $1
      ${EndIf}
    ...
    loop_ver2:
      StrCmp $1 "" ver3
      DetailPrint "Looking for emacs version in emacs\bin\emacs- ($1)"
      StrCpy $1 $1 "" 6
      StrCpy $1 $1 -4
      StrCpy $2 $1
      DetailPrint "($1-> $2)"
    ...
    ver3:
      FindFirst $0 $1 $EXEDIR\..\emacs\bare-bin-*.7z
      
    loop_ver3:
      StrCmp $1 "" done_ver
      DetailPrint "Looking for emacs version in emacs\bare-bin-* ($1)"
      StrCpy $1 $1 "" 9
      StrCpy $1 $1 -3
      StrCpy $2 $1
      DetailPrint "($1-> $2)"
...
#+BEGIN_SRC nsis
  Function SetupDirs
    ...
    ${ElseIf} ${FileExists} "$EXEDIR\..\emacs\share\emacs\$option_version\etc"
      System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("EMACSDATA", "$EXEDIR\..\emacs\share\emacs\$option_version\etc").r0'
      System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("EMACSDOC", "$EXEDIR\..\emacs\share\emacs\$option_version\etc").r0'
      System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("EMACSLOADPATH", "$EXEDIR\..\site-lisp;$EXEDIR\..\emacs\share\emacs\$option_version\lisp").r0'
      System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("INFOPATH", "$EXEDIR\..\emacs\share\info").r0'
      System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("EPOTHER","$EXEDIR\..\..\Other\").r0'
    ${EndIf}
  FunctionEnd
  ...
  Function CreateZip
    ...
    found_7z:
      ...
      ${Else} 
        ...
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\emacs-$option_version.exe $TEMP\epz\emacs-$option_version\bin\emacs.exe
        
        CopyFiles /SILENT $EXEDIR\..\emacs\share\emacs\$option_version\etc\DOC* $TEMP\epz\emacs-$option_version\share\emacs\$option_version\etc
        
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\emacsclient.exe $TEMP\epz\emacs-$option_version\bin\emacsclient.exe
        
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\runemacs.exe $TEMP\epz\emacs-$option_version\bin\runemacs.exe
        
        CopyFiles /SILENT $EXEDIR\..\emacs\bin\*tags* $TEMP\epz\emacs-$option_version\bin
        
        CopyFiles /SILENT $EXEDIR\..\emacs\libexec\emacs\$option_version\i686-pc-mingw32\* $TEMP\epz\emacs-$option_version\libexec\emacs\$option_version\i686-pc-mingw32
        
        SetOutPath $TEMP\epz
        ExecWait '"$EXEDIR\..\7z\7zG.exe" a -mx9 -t7z bare-bin-$option_version.7z emacs-$option_version\bin\emacs.exe emacs-$option_version\share\emacs\$option_version\etc\DOC* -mmt -ms=on -m0=PPMd'
        ExecWait '"$EXEDIR\..\7z\7zG.exe"  a -mx9 -t7z ext-bin-$option_version.7z \
         ...
         RmDir /R "$EXEDIR\..\emacs\libexec\emacs\$option_version"
         
         Delete "$EXEDIR\..\emacs\emacs-$option_version.exe"
...
#+BEGIN_SRC nsis
  Section "Main" sec_mainN
    ...
    ${Else}
      ...
      loop_proxy2:
        HideWindow
        StrCmp $1 "" done_proxy2
        DetailPrint "Checking for running $1.exe"
        FindProcDLL::FindProc "$1.exe"
        StrCmp "$R0" "1" 0 loop_next2
        DetailPrint "$1 is running"
        StrCpy $2 $1 "" 6
        StrCpy $2 $2 -4
        IfFileExists "$EXEDIR\..\emacs\bin\emacsclient.exe" 0 +3
        StrCpy $3 "$EXEDIR\..\emacs\bin\emacsclient.exe"
        Goto +3
        IfFileExists "$real_temp\ep\emacs-$2\bin\emacsclient.exe" 0 loop_next2
        StrCpy $3 "$real_temp\ep\emacs-$2\bin\emacsclient.exe"
        SetOutPath $home
        Exec '"$3" --server-file "$real_temp\ep\EmacsPortable.App-Server-$option_version$epstart\server" --eval "(if (fboundp $\'refresh-proxy) (refresh-proxy))"'
      loop_next2:
