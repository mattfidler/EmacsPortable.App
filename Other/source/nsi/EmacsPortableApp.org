...
I want:
 ...
 - CRC check
 - Fastest compression (zlib)  See http://forums.winamp.com/showthread.php?t=186355
#+BEGIN_SRC nsis
CRCCheck On
...
#+BEGIN_SRC nsis
  !macro emacs_setup
    ...
    ${AddToEnvironment}
    DetailPrint "Setup Emacs Registry"
    SetOutPath "$TEMP\ep"
    File "..\..\..\App\eps\ep-reg.exe"
    WriteIniStr "$TEMP\ep\ep.ini" "EmacsPortableApp" "EXEDIR" "$EXEDIR"
    Exec "$TEMP\ep\ep-reg.exe"
