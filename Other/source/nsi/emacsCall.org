...
#+BEGIN_SRC nsis
  Function ExtractZip
    ...
    ExecWait '"$EXEDIR\App\7z\7zG.exe" x "$INSTDIR\App\emacs-$option_version\bare-bin.zip" -o$TEMP\ep'
    ExecWait '"$EXEDIR\App\7z\7zG.exe" x "$INSTDIR\App\emacs-$option_version\ext-bin.zip" -o$TEMP\ep"'
    Goto end
    end:
      ClearErrors
      Push $R0
