...
#+BEGIN_SRC nsis
  ...
  !macro getEmacsWin VER
    ...
    ExecWait '"$EXEDIR\App\7z\7zg.exe" x "$TEMP\emacs.zip" -o"$INSTDIR\App\install"'
...
#+BEGIN_SRC nsis
  ...
  !macro DOWN VAL OUT
    ...
    zip:
      ...
      Goto +2
      ExecWait '"$EXEDIR\App\7z\7zG.exe" x "$TEMP\${VAL}.zip" -o"${OUT}"'
      Delete "$TEMP\${VAL}.zip"
      Goto end
    git:
...
#+BEGIN_SRC nsis
  ...
  !macro g32down WHAT
    ...
    g32_zip:
      ...
      ExecWait '"$EXEDIR\App\7z\7zG.exe" x "$TEMP\${WHAT}-bin.zip" -o"$TEMP\ep-gw32"'
      StrCpy $R0 "${WHAT}"
      StrCpy $R1 "bin"
      ...
      RmDir /r "$TEMP\ep-gw32"
      ExecWait '"$EXEDIR\App\7z\7zG.exe" x "$TEMP\${WHAT}-dep.zip" -o"$TEMP\ep-gw32"'
...
#+BEGIN_SRC nsis
  ...
  !macro ezwindown WHAT
    ...
    ExecWait '"$EXEDIR\App\7z\7zG.exe" x "$TEMP\${WHAT}-bin.zip" -o"$TEMP\ep-ezwin"'
